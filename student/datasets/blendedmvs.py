...
class MVSDataset(Dataset):
    def __init__(self, datapath,check_depth_path, listfile, split, nviews, img_wh=(768, 576), robust_train=True):
        
        super(MVSDataset, self).__init__()
        self.levels = 4 
        self.datapath = datapath
        self.check_depth_path = check_depth_path
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            depth_filename = os.path.join(self.check_depth_path, '{}/checked_depth/{:0>8}.pfm'.format(scan, vid))
