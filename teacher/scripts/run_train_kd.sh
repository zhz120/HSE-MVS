DATASET_DIR="/home/god/datasets/dtu-cas/dtu/"	# path to dataset folder
...
#LOAD_CKPT_DIR="outputs/student_kd_train_iter2_normal/model_kd_dtu.ckpt"	# path to checkpoint of the teacher model
...
EST_DEPTH_DIR="$LOG_DIR/00_te_st_kd_0_1_10_outputs_tescher_model/est_depth/"
...
CHECKED_DEPTH_DIR="$LOG_DIR/00_te_st_kd_0_1_10_outputs_tescher_model/checked_depth_normal_version/" # for unsup teacher model
NGPUS=4
BATCH_SIZE=2
...
LOG_DIRS="$LOG_DIR/00_te_student_kd_0_1_10_train_iter3_normal/" # use normal version pseudo label
